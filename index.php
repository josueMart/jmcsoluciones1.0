   ...
   <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner">
      <div class="carousel-item active">
        <img class="d-block w-100  slide-img" src="http://localhost:8888/wp-content/uploads/2017/12/slide2.png" alt="First slide">
      </div>
      <div class="carousel-item">
        <img class="d-block w-100 slide-img" src="http://localhost:8888/wp-content/uploads/2017/12/slide2.png" alt="Second slide">
      </div>
      <div class="carousel-item">
        <img class="d-block w-100 slide-img" src="http://localhost:8888/wp-content/uploads/2017/12/slide2.png" alt="Third slide">
      </div>
    </div>
...
<!-- Seccion OFERTAS -->
<div class="row justify-content-around" id="access-direct-row">
  <div class="col-lg-2 col-md-3 col-sm-6 access-direct ">
    <a href="" class="direct-link">
      <div class="row">
      <img class="img-access-direct" src="http://localhost:8888/wp-content/uploads/2017/12/laptop.jpg" alt="">
    </div>
...
<!-- <div class="row">
  <div class="col">
   <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner">
      <div class="carousel-item active">
        <img class="d-block w-100  slide-img" src="http://localhost:8888/wp-content/uploads/2017/12/parts1.png" alt="First slide">
      </div>
      <div class="carousel-item">
        <img class="d-block w-100 slide-img" src="http://localhost:8888/wp-content/uploads/2017/12/parts2.png" alt="Second slide">
      </div>
      <div class="carousel-item">
        <img class="d-block w-100 slide-img" src="http://localhost:8888/wp-content/uploads/2017/12/parts3.png" alt="Third slide">
      </div>
    </div>
    <a class="carousel-control-prev" href="#carouselExampleIndicators" role="button" data-slide="prev">
      <span class="carousel-control-prev-icon" aria-hidden="true"></span>
